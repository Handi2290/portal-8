...
class JadwalController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.dosen.jadwal.index', compact('list_tahun_akademik', 'list_hari', 'list_jadwal','list_waktu_kuliah'));
    }
    ...
    public function print($id)
    {
        ...
        return view('pages.dosen.jadwal.print', compact('list_tahun_akademik', 'dosen', 'list_hari', 'list_jadwal', 'list_waktu_kuliah'));
    }
}
