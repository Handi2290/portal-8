...
class MahasiswaController extends Controller
{
    ...
    public function jadwal()
    {
        ...
        if ($t) {
            ...
            $list_jadwal = DB::table('t_jadwal AS j')
                ...
                ->leftjoin('tbl_waktu_kuliah AS wk', 'j.id_waktu_kuliah', '=', 'wk.id_waktu_kuliah')
    ...
    function khs()
    {
        ...
        //     return redirect()->route('mahasiswa.khs.status');
        // } if (empty($kuesioner_form->nim = $mahasiswa->nim && $kuesioner_form->tahun_akademik = $tahun_akademik)){
...
*/
    ...
    public function status(){
        return view('pages.mahasiswa.khs.status');
    }
/* KHS lama
...
// KHS Cpenk
    ...
    public function print_skpi(){
        ...
        return view('pages/mahasiswa/skpi/print', compact('nim','nama','keterangan','skpi'));
    }
    // print skpi end
