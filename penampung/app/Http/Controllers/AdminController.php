...
class AdminController extends Controller
{
    ...
    // Menu kategori Pembayaran & Pembayaran akhir

    function kategori_pembayaran_akhir(){
        return view('pages.admin.pembayaran.kategori_akhir.index');
    }

    function pembayaran_akhir(){

            return view('pages.admin.pembayaran_akhir.index');
        //  return redirect()->route('admin.pembayaran_akhir.index');
    }

    function pembayaran_sidang(){

        return view('pages.admin.pembayaran_sidang.index');
    //  return redirect()->route('admin.pembayaran_akhir.index');
    }

    function pembayaran_wisuda(){

        return view('pages.admin.pembayaran_wisuda.index');
    //  return redirect()->route('admin.pembayaran_akhir.index');
    }
    ...
    function skpi()
    {
        return view('pages.admin.skpi.index');
    }
