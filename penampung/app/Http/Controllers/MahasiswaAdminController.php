    ...
    public function datatable(Request $request)
    {
        ...
        $no = 1;
         ...
         $list_mahasiswa = Mahasiswa::select([
             ...
             'tbl_waktu_kuliah.*',
             'tbl_waktu_kuliah.nama_waktu_kuliah as nama_waktu_kuliah',
             'm_kelas_detail.*',
             'm_kelas.*',
        ...
        foreach ($list_mahasiswa as $list) {
            if ($list->is_disable_spp == 1) {
                $btn_spp = '<a href="'.route('admin.mahasiswa.disable_spp', $list->id_mahasiswa).'" class="btn btn-success btn-sm">Enable SPP</a>';
            } else {
                $btn_spp = '<a href="'.route('admin.mahasiswa.disable_spp', $list->id_mahasiswa).'" class="btn btn-danger btn-sm">Disable SPP</a>';
            }
            ...
            $data[] = array(
                ...
                'waktu_kuliah' => ! empty($list->nama_waktu_kuliah) ? $list->nama_waktu_kuliah : '-',
