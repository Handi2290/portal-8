    ...
    public function datatable(Request $request)
    {
        ...
        foreach ($list_mahasiswa as $list) {
            ...
            $data[] = [
                ...
                'view' => '<button type="button" value="'.$list->nim.'" class="btn btn-info btn-sm" title="Cek Bukti Pembayaran" enable><i class="fa fa-eye"> Cek Bukti Bayar</i></a>'
            ];
        }
