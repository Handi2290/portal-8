...
Route::group(['middleware' => 'web'], function(){
	...
	Route::group(['prefix' => 'admin'], function(){
		...
		Route::group(['middleware' => 'auth:admin'], function () {
			...
			// Pembayaran Mahasiswa Akhir
			Route::group(['prefix' => 'pembayaran_akhir'], function(){
				Route::get('/skripsi', 'AdminController@pembayaran_akhir')->name('admin.pembayaran_akhir');
				// Route::get('/sidang', 'AdminController@pembayaran_sidang')->name('admin.pembayaran_akhir.sidang');
				// Route::get('/wisuda', 'AdminController@pembayaran_wisuda')->name('admin.pembayaran_akhir.wisuda');
				
				Route::get('datatable', 'PembayaranAkhirController@datatable')->name('admin.pembayaran_akhir.datatable');
				// Route::get('datatable', 'PembayaranAkhirController@datatable_skripsi')->name('admin.pembayaran_akhir.datatable_sidang');
				// Route::get('datatable', 'PembayaranAkhirController@datatable_skripsi')->name('admin.pembayaran_akhir.datatable_wisuda');

				Route::get('{id}/{dp}/bayar', 'PembayaranAkhirController@bayar')->name('admin.pembayaran_akhir.bayar');
				Route::post('{id}/{dp}/bayar', 'PembayaranAkhirController@simpan')->name('admin.pembayaran_akhir.simpan');
				Route::get('{id}/print', 'PembayaranAkhirController@print')->name('admin.pembayaran_akhir.print');
				Route::get('{id}/{dp}/{dpd}/hapus', 'PembayaranAkhirController@hapus')->name('admin.pembayaran_akhir.hapus');
			});
			// ENDs
			...
			Route::group(['prefix' => 'kategori-pembayaran'], function(){
				...
				// Kategori Biaya Akhir
				// Skripsi - Sidang - Wisuda
				Route::group(['prefix' => 'akhir'], function(){
					Route::get('/', 'AdminController@kategori_pembayaran_akhir')->name('admin.pembayaran.akhir');
					Route::get('trash', 'KategoriPembayaranAkhirController@trash')->name('admin.pembayaran.akhir.trash');

					Route::get('datatable', 'KategoriPembayaranAkhirController@datatable')->name('admin.pembayaran.akhir.datatable');
					Route::get('datatable/trash', 'KategoriPembayaranAkhirController@datatable')->name('admin.pembayaran.akhir.trash.datatable');

					Route::get('tambah', 'KategoriPembayaranAkhirController@tambah')->name('admin.pembayaran.akhir.tambah');
					Route::post('tambah', 'KategoriPembayaranAkhirController@simpan')->name('admin.pembayaran.akhir.simpan');

					Route::get('{id}/ubah', 'KategoriPembayaranAkhirController@ubah')->name('admin.pembayaran.akhir.ubah');
					Route::post('{id}/ubah', 'KategoriPembayaranAkhirController@perbarui')->name('admin.pembayaran.akhir.perbarui');

					Route::get('{id}/restore', 'KategoriPembayaranAkhirController@restore')->name('admin.pembayaran.akhir.restore');
					Route::get('{id}/hapus', 'KategoriPembayaranAkhirController@toTrash')->name('admin.pembayaran.akhir.hapus');
					Route::get('{id}/hapus-permanen', 'KategoriPembayaranAkhirController@hapus')->name('admin.pembayaran.akhir.hapus.permanen');
				});
				// ENDs
			...
			Route::group(['prefix' => 'krs'], function () {
				Route::group(['prefix' => 'approve'], function () {
					...
					Route::post('/krs_ditolak', 'Admin\KRSApproveController@krs_ditolak')->name('admin.krs.approve.krs_ditolak');
				});
			...
			Route::group(['prefix' => 'dispensasi_spp'], function () {
				...
				Route::get('{id}/print', 'Admin\DispensasiSPPController@print')->name('admin.dispensasi_spp.print');
			...
			Route::group(['prefix' => 'skpi'], function () {
				Route::get('/','Admin\SkpiController@index')->name('admin.skpi.index');
				Route::get('/cari','Admin\SkpiController@cari')->name('admin.skpi.cari');	
				Route::post('{id}/confirm','Admin\SkpiController@confirm')->name('admin.skpi.confirm');
				Route::post('{id}/tolak','Admin\SkpiController@tolak')->name('admin.skpi.tolak');
				Route::get('{id}/cancel','Admin\SkpiController@cancel')->name('admin.skpi.cancel');
				Route::get('{id}/hapus','Admin\SkpiController@hapus')->name('admin.skpi.hapus');
			});

			Route::group(['prefix' => 'pengajuan'], function () {
				Route::get('/','Admin\PengajuanController@index')->name('admin.pengajuan.index');
				Route::get('/cari','Admin\PengajuanController@cari')->name('admin.pengajuan.cari');	
				Route::get('{id}/confirm','Admin\PengajuanController@confirm')->name('admin.pengajuan.confirm');
				Route::get('{id}/tolak','Admin\PengajuanController@tolak')->name('admin.pengajuan.tolak');
				Route::get('{id}/cancel','Admin\PengajuanController@cancel')->name('admin.pengajuan.cancel');
				Route::get('{id}/hapus','Admin\PengajuanController@hapus')->name('admin.pengajuan.hapus');
			});
		});
	});
	...
	Route::group(['prefix' => 'mahasiswa'], function() {
		...
		Route::group(['middleware' => 'auth:mahasiswa'], function () {
			Route::get('mahasiswa', 'Mahasiswa\DashboardController@index')->name('mahasiswa.home');
			Route::get('timeline_jadwal/{semester}/{ket}', 'Mahasiswa\DashboardController@timeline_jadwal')->name('mahasiswa.home.timeline_jadwal');
			Route::get('timeline_pembayaran/{semester}/{ket}', 'Mahasiswa\DashboardController@timeline_pembayaran')->name('mahasiswa.home.timeline_pembayaran');
			...
			Route::group(['prefix' => 'info'], function(){
				Route::get('/', 'InfoController@mahasiswa')->name('mahasiswa.info');
			});
			...
			Route::group(['prefix' => 'hasil-studi'], function(){
				...
				Route::get('semester2/{semester}/{ket}', 'KHSController@semester2')->name('mahasiswa.khs.semester');

				// Status
				Route::get('/status', 'MahasiswaController@status')->name('mahasiswa.khs.status');
			});
			...
			Route::group(['prefix' => 'kehadiran'], function () {
				...
				Route::get('absen', 'Mahasiswa\AbsensiController@absen')->name('mahasiswa.absen');
				Route::patch('/{id_kelas}/{id_matkul}/{nim}/{tanggal}/absen/save', 'Mahasiswa\AbsensiController@save')->name('mahasiswa.absensi.absen');
			});
			...
			Route::get('/', 'Mahasiswa\PembayaranSPPController@cek')->name('mahasiswa.cek_bayar');

			Route::group(['prefix' => 'pembayaran_spp'], function () {
				Route::get('/', 'Mahasiswa\PembayaranSPPController@index')->name('mahasiswa.pembayaran_spp');
				
				Route::get('/{id_tahun_akademik}/get_pembayaran_spp', 'Mahasiswa\PembayaranSPPController@get_pembayaran_spp_datatable')->name('mahasiswa.pembayaran_spp.get_pembayaran_spp');
				Route::get('/get_pembayaran_spp/upload','Mahasiswa\PembayaranSPPController@uploadView')->name('mahasiswa.pembayaran_spp.upload');
				Route::post('/get_pembayaran_spp/upload','Mahasiswa\PembayaranSPPController@uploadFile')->name('mahasiswa.pembayaran_spp.uploadFile');
				Route::get('show','Mahasiswa\PembayaranSPPController@show')->name('mahasiswa.pembayaran_spp.show');
			});

			Route::group(['prefix' => 'pembayaran/akhir'], function () {

				Route::get('/{kategori}', 'Mahasiswa\PembayaranAkhirController@index')->name('mahasiswa.pembayaran_akhir');
				Route::get('ajax/{kategori}', 'Mahasiswa\PembayaranAkhirController@datatable')->name('mahasiswa.pembayaran_akhir_datatable');

				Route::get('upload/{kategori}','Mahasiswa\PembayaranAkhirController@uploadView')->name('mahasiswa.pembayaran_akhir.upload');
				Route::post('upload/{kategori}','Mahasiswa\PembayaranAkhirController@uploadFile')->name('mahasiswa.pembayaran_akhir.uploadFile');

				Route::get('show/{kategori}','Mahasiswa\PembayaranAkhirController@show')->name('mahasiswa.pembayaran_akhir.show');

			});

			Route::group(['prefix' => 'pembayaran/pendaftaran'], function () {
				Route::get('/', 'Mahasiswa\PembayaranPendaftaranController@index')->name('mahasiswa.pembayaran_pendaftaran');
			});

			Route::group(['prefix' => 'pembayaran/bangunan'], function () {
				Route::get('/', 'Mahasiswa\PembayaranBangunanController@index')->name('mahasiswa.pembayaran_bangunan');
			});
			...
			//Route::get('/', 'Mahasiswa\CetakJadwalUjianController@print')->name('mahasiswa.cetak_jadwal_ujian.print');
			});
			...
			Route::group(['prefix' => 'kuesioner'], function () {
				...
				// info
				Route::get('/info', 'Mahasiswa\DashboardController@statusKuesioner')->name('mahasiswa.kuesioner.status');
			});
			
			//skpi,skripsi

			Route::group(['prefix' => 'pengajuan'], function () {
				Route::get('/', 'Mahasiswa\PengajuanController@index')->name('mahasiswa.pengajuan');
				Route::post('/simpan', 'Mahasiswa\PengajuanController@save')->name('mahasiswa.pengajuan.simpan');
				Route::get('/hapus/{skpi}', 'Mahasiswa\PengajuanController@delete')->name('mahasiswa.pengajuan.hapus');
				Route::get('/print', 'Mahasiswa\PengajuanController@print_pengajuan')->name('mahasiswa.pengajuan.print');
			});
			
			Route::group(['prefix' => 'skpi'], function () {
				Route::get('/', 'Mahasiswa\SkpiController@index')->name('mahasiswa.skpi');
				Route::post('/simpan', 'Mahasiswa\SkpiController@save')->name('mahasiswa.skpi.simpan');
				Route::get('/hapus/{skpi}', 'Mahasiswa\SkpiController@delete')->name('mahasiswa.skpi.hapus');
				Route::get('/print', 'Mahasiswa\SkpiController@print_skpi')->name('mahasiswa.skpi.print');
			});
	...
	Route::group(['prefix' => 'admin_smk'], function(){
		...
		Route::group(['prefix' => 'kategori_info'], function(){
            ...
            Route::group(['prefix' => 'profil'], function(){
				Route::get('/', 'ProfilController@profil')->name('karyawan.profil');

				Route::get('{id}/ubah', 'ProfilController@ubah')->name('karyawan.profil.ubah');
				Route::post('{id}/ubah', 'ProfilController@perbarui')->name('karyawan.profil.perbarui');

				Route::post('ubah-foto', 'ProfilController@foto')->name('karyawan.profil.foto');
				Route::get('hapus-foto', 'ProfilController@hapus_foto')->name('karyawan.profil.foto.hapus');
			});
	...
	Route::get('login-mhs', 'Auth\LoginController@loginMhs');
	Route::get('login-keu', 'Auth\LoginController@loginKeu');
	Route::get('login-adm', 'Auth\LoginController@loginAdmin');
