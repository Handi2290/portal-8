...
class Pendaftaran extends \Eloquent implements Authenticatable
{
    ...
    protected $fillable = [
        'id_daftar', 'nama', 'no_telp', 'alamat', 'id_provinsi', 'id_waktu_kuliah', 'tahun_akademik', 'tanggal_lahir', 'tempat_lahir', 'id_prodi', 'id_kampus', 'id_skpi', 'id_jenjang', 'id_promo', 'status_bayar', 'bayar', 'registration', 'id_status', 'transkrip', 'tanggal_pembayaran', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'is_delete'
    ];
