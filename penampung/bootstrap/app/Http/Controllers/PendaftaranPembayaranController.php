...

{
...

    {
...

        {
            ...
            $url = "http://portal.stieppi.ac.id/admin/pendaftaran/baru/pembayaran-kelulusan/".$id."/".$dp."/print";

            echo "<script>window.open('".$url."', '_blank')</script>"; 

            $urle = "http://portal.stieppi.ac.id/admin/pendaftaran/baru/pembayaran-kelulusan";
   ...
   public function dispensasi($id, $dp) {
...

    {
...

        {
            ...
            $url = "http://portal.stieppi.ac.id/admin/pendaftaran/baru/pembayaran-kelulusan/". $id ."/". $dp ."/dispensasi/print";
