<header class="main-header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  @if(Request::segment(1) == 'mahasiswa')
    <span class="logo-lg"><b>STIE</b> PPI</span>
  @elseif(Request::segment(1) == 'dosen')
    <span class="logo-lg"><b>STIE</b> PPI</span>
  @elseif(Request::segment(1) == 'admin')
    <span class="logo-lg"><b>STIE</b> PPI</span> 
  @elseif(Request::segment(1) == 'admin_smk')
    <span class="logo-lg"><b>SMK</b> PPI</span> 
  @elseif(Request::segment(1) == 'admin_smp')
    <span class="logo-lg"><b>SMP</b> PPI</span> 
  @endif  
  </a>
  ...
  <nav class="navbar navbar-static-top">
    ...
    <div class="navbar-custom-menu">
      ...
      <ul class="nav navbar-nav">
        <li class="pull-left">
        <a href="{{ route('mahasiswa.pengumuman') }}" class="dropdown-toggle" data-toggle="dropdown">
            <i class="fa fa-id-card"></i>
        <span class="label label-warning">Pengumuman!</span></a>
        </li>
