	...
	<section class="content">
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				@foreach ((array)$jadwal as $j)
					{!! Form::hidden('id_dosen', $j->id_dosen) !!}
					{!! Form::hidden('nim', $j->nim) !!}
					{!! Form::hidden('id_semester', $j->id_semester) !!}
					{!! Form::hidden('id_matkul', $j->id_matkul) !!}
					{!! Form::hidden('id_kelas', $j->id_kelas) !!}
					{!! Form::hidden('tahun_akademik', $j->tahun_akademik) !!}
					...
					<table class="table">
						<thead>
							<tr>
								...
								<td width="5">:</td>
								<td>{{ $j->kode_matkul }} - {{ $j->nama_matkul }}</td>
							</tr>
							<tr>
