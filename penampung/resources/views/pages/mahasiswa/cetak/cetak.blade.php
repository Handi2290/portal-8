		...
		@if( $spp_terbayar == $bulan )
			@if (Request::isMethod('POST'))
				<div class="pull-right">
					...
					@else
					    <!--<a href='{{ route('mahasiswa.cetak.uas.front', [$ujian->jenis_ujian, $ujian->id_tahun_akademik ] ) }}/print' class='btn btn-primary btn-sm' target='_blank'><i class='fa fa-print'></i>Test Print</a>-->
