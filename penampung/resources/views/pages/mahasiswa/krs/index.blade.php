					...
					success: function (data) {
						...
						if (data.status === 'success') {
							...
							if (data.data.status === 'Y') {
								...
								//<a href='{{ route('mahasiswa.krs') }}/print' class='btn btn-primary btn-sm' target='_blank'><i class='fa fa-print'></i> Print KRS</a>";
								...
								status = "<span class='text-danger'>Menunggu Persetujuan</span>";
