					...
					<thead>
                      ...
                      <tbody>
                        ...
                        <tr align="center">
                          ...
                          <!--<th>Kelas</th>
						  <td>: {{ @$m_kelas->id_kelas. '' .@$m_kelas->kode_kelas }}</td>-->
           ...
           <div class="table-responsive">
				<table class="kolom" width="100%" cellspacing="0">
					<tr>
						...
						<th width="14%"></th>
						<th width="9%">&nbsp;</th>
						<th width="32%">Tangerang, <?php echo date("d M Y ")  ?></th>
					</tr>
					<tr>
						<th>&nbsp;</th>
						<th>Menyetujui :</th>
					...
					<tr>
						<th height="83">&nbsp;</th>
						<th valign="bottom">{{@$mahasiswa->gelar_depan}} {{@$mahasiswa->nama_dosen}} {{@$mahasiswa->gelar_belakang}}</th>
						<th></th>
						<th>&nbsp;</th>
						<th valign="bottom">{{@$mahasiswa->nama_mhs}}</th>
					</tr>
					<tr>
					  <th height="21">&nbsp;</th>
					  <th>&nbsp;</th>
