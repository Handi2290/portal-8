...
@section('main')
	...
	<section class="content-header">
		<h1>Upload Bukti Pembayaran Akhir</h1>
	</section>
	{{-- ./ content-header --}}
	...
	<section class="content">
		...
		<div class="box box-default">
			...
			{{-- box-body --}}
			<div class="box-body">
				<form class="row" enctype='multipart/form-data' action="{{ route('mahasiswa.pembayaran_akhir.uploadFile', request()->segment(5)) }}" method="POST">
					...
					<div class="col-md-6 col-md-offset-3">
						...
						<div class="form-group">
							...
							<a href="{{ route('mahasiswa.pembayaran_akhir', request()->segment(5)) }}" class="btn btn-warning">
								Kembali
							</a>
						</div>
						{{-- ./ form-group --}}
