<div class="box box-primary">
        ...
        <table class="table">
            <tbody>   
                ...
                <img src="{{ asset('images/default-avatar.png') }}" class="img-circle" style="height:175px; width:175px; align:center;" >
                @else
                    <img src="{{ asset('images/mahasiswa/'.Auth::guard('mahasiswa')->user()->foto_profil) }}" class="img-circle" style="height:175px; width:175px; align:center;" >
                </div></div>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ Auth::guard('mahasiswa')->user()->id_semester }}</td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td align="right"><a href="{{ route('mahasiswa.profil') }}" class="btn btn-info btn-flat">Setting Profile</a></td>
                </tr>
            </tbody>
        </table>
