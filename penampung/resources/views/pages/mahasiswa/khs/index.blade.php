  ...
  <div class="row">
  	<div class="col-xs-12">
          ...
          <div class="form-inline">
            ...
            <button id="btn_transkrip" type="button" class="btn btn-primary">Transkrip</button>
...
<script type="text/javascript">
  ...
  $('#btn_transkrip').click(function(data){
      var url = "{{ url('mahasiswa/hasil-studi/semester/all') }}/";
      $("#data").html('Loading...');
