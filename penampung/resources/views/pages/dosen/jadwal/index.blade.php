						...
						<table class="table table-bordered">
							<thead>
								<tr>
									...
									<th width="100" class="text-center">Waktu Kuliah</th>
									<th width="100" class="text-center">Kelas</th>
									<th width="200" class="text-center">Nama Mata Kuliah</th>
								</tr>
							</thead>
							<tbody>
										...
										<tr>
											...
											@foreach ($list_jadwal->where('hari', $hari) as $jadwal)
												<tr>
													...
													<td class="text-center">{{ ! empty($jadwal->waktu_kuliah->id_waktu_kuliah) ? $jadwal->waktu_kuliah->id_waktu_kuliah : '-' }}</td>
