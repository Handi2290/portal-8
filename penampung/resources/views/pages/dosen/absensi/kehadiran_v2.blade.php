<div class="modal fade" id="modal-edit-absensi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['method' => 'PATCH', 'route' => ['dosen.absensi.edit_absensi', $kelas->id_kelas, $matkul->id_matkul, $jadwal->id_jadwal]]) !!}
...
<div class="box box-default">
	<div class="box-header with-border">
		<a href="{{ route('dosen.absensi.form_absensi', [$kelas->id_kelas, $matkul->id_matkul, $jadwal->id_jadwal]) }}" class="btn btn-primary"><i class="fa fa-check-square-o"></i> Buka Absen Mahasiswa</a>
	</div>
	<div class="box-body">
						...
						@for ($i = 0; $i <= 15; $i++)
							...
							@else
								<th class="text-center">
									{{ $i + 1 }}<br/>
									<a href="{{ route('dosen.absensi.form_edit', [$kelas->id_kelas, $matkul->id_matkul, $jadwal->id_jadwal, $pertemuan[$i]->tanggal, $pertemuan[$i]->pertemuan_ke]) }}" data-toggle="tooltip" data-placement="top" title="Edit Absensi"><i class="fa fa-fw fa-edit"></i></a>
									<a href="{{ route('dosen.absensi.hapus_absensi', [$kelas->id_kelas, $matkul->id_matkul, $jadwal->id_jadwal, $pertemuan[$i]->tanggal, $pertemuan[$i]->pertemuan_ke]) }}" data-toggle="tooltip" data-placement="top" title="Hapus Absensi"><i class="fa fa-fw fa-remove"></i></a>
								</th>
							@endif
						@endfor
					</tr>
