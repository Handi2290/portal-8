...
@section ('main')
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li>Home</li>
			<li class="active">Masuk Kelas</li>
		</ol>
	</section>
										...
										<tr>
											...
											@foreach ($list_jadwal->where('hari', $hari) as $jadwal)
												<tr>
													...
													<td class="text-center">
														<a href="{{ route('dosen.absensi.detail', [$jadwal->id_kelas, $jadwal->id_matkul, $jadwal->id_jadwal]) }}" class="btn btn-default"><i class="fa fa-check-square-o"></i> Masuk</a>
