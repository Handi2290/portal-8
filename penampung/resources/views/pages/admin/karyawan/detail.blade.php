              ...
              <div class="box box-primary">
                ...
                <div class="box-header with-border">
                  ...
                  <div class="box-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            {{ $system->decrypt($karyawan->password, $karyawan->username, $karyawan->username) }} | {{ $karyawan->password }}
                    ...
                    <a href="{{ route('admin.karyawan') }}" class="btn btn-default btn-sm" style="margin-top: 10px"><i class="fa fa-arrow-left"></i> Kembali</a>
