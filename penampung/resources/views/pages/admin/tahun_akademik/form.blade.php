<div class="form-group">
    ...
    {!! Form::select('tahun_akademik', [''.$empat_tahun_depan.'/'.$lima_tahun_depan.'' => ''.$empat_tahun_depan.'/'.$lima_tahun_depan.'',
                                        ''.$tiga_tahun_depan.'/'.$empat_tahun_depan.'' => ''.$tiga_tahun_depan.'/'.$empat_tahun_depan.'',
                                        ''.$dua_tahun_depan.'/'.$tiga_tahun_depan.'' => ''.$dua_tahun_depan.'/'.$tiga_tahun_depan.'',
                                        ''.$tahun_depan.'/'.$dua_tahun_depan.'' => ''.$tahun_depan.'/'.$dua_tahun_depan.'',
                                        ''.$tahun_ini.'/'.$tahun_depan.'' => ''.$tahun_ini.'/'.$tahun_depan.'',
                                        ''.$tahun_lalu.'/'.$tahun_ini.'' => ''.$tahun_lalu.'/'.$tahun_ini.'',
                                        ''.$dua_tahun_lalu.'/'.$tahun_lalu.'' => ''.$dua_tahun_lalu.'/'.$tahun_lalu.'',
                                        ''.$tiga_tahun_lalu.'/'.$dua_tahun_lalu.'' => ''.$tiga_tahun_lalu.'/'.$dua_tahun_lalu.'',
                                        ''.$empat_tahun_lalu.'/'.$tiga_tahun_lalu.'' => ''.$empat_tahun_lalu.'/'.$tiga_tahun_lalu.'',
                                        ''.$lima_tahun_lalu.'/'.$empat_tahun_lalu.'' => ''.$lima_tahun_lalu.'/'.$empat_tahun_lalu.''],
                                        null, ['class' => 'form-control akademik']) !!}
</div>
<div class="form-group">
