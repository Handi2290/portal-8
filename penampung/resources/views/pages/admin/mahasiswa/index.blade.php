					...
					<table class="table table-striped mahasiswa">
						<thead>
							<tr>
								...
								<th width="150" class="text-center">Nama Mahasiswa</th>
								<th class="text-center">Kelas</th>
								<th width="150" class="text-center">Waktu Kuliah</th>
								<th width="150" class="text-center">Tempat, Tanggal Lahir</th>
								<th width="150" class="text-center">Penasihat Akademik</th>
