		...
		<div>
			...
			<div class="table-responsive">
				<table width="100%" cellspacing="0">
					...
					<tr>
						<td>Promo</td>
						<td style="border-bottom: 1px solid black; text-align: right; ">: Rp. {{ $daftar->promo }}</td>	
					</tr>
					<tr>
						<td style="text-align: right;">Biaya Harus Dibayar</td>
						<td style="text-align: right; font-weight: bold;">: Rp. {{ $daftar->biaya }}</td>
					</tr>
