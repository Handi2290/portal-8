			...
			<tbody>
				<tr>
					<td width="40%" align="right" valign="center">
						<img src="{{asset('images/logo/ppi.png')}}" width="40px">
					</td>
					<td width="60%" align="left" valign="top">
						<br>
						<h4 style="color: black; margin-top: 5px; ">Sekolah Tinggi Ilmu Ekonomi Putra Perdana Indonesia</h4>
						<p style="text-align: color: black; padding-top: 0px; font-size:9.5px">Jl. Citra Raya Utama Barat, Griya Harsa II Blok i 10 no. 29, Cikupa 15710 - Tangerang.</p>
					</td>
				</tr>
			</tbody>
		    </table>
