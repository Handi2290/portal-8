...
<section class="content-header">
  <h1>
    Detail Pembayaran Kelulusan Mahasiswa Akhir
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#"><i class="fa fa-file-text-o"></i> Detail Pembayaran</a></li>
    <li class="active">Detail Pembayaran Kelulusan Mahasiswa Akhir</li>
  </ol>
</section>
  	...
  	<div class="col-md-12">
  		<div class="box box-default">
  			<div class="box-header with-border">
  				<h3 class="box-title">Detail Pembayaran Kelulusan Mahasiswa Akhir
          </h3>
  			</div>
            ...
            <div class="row">
              ...
              <div class="table-responsive">
                ...
                <table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
                 ...
                 <a href="{{ route('admin.pembayaran_akhir') }}" class="btn btn-default">Kembali</a>
            </div>
          </div>
  			</div>
  		</div>
