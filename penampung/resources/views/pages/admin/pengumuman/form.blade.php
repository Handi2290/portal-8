...
<div class="form-group">
    {!! Form::label('umumkan_ke', 'Umumkan Kepada', ['class' => 'control-label']) !!}
    {!! Form::select('umumkan_ke', ['Semua' => 'Semua', 'Dosen' => 'Dosen', 'Mahasiswa' => 'Mahasiswa', 'Staff' => 'Staff'], null, ['class' => 'form-control']) !!}
</div>
