    ...
    <section class="content">
        ...
        <table class="table table-responsive">
            ...
            <tr>
                ...
                <td class="text-center" width="30"><a target="_blank" href="/images/skpi/{{$data->kelengkapan}}">Lihat</a></td>
                <td class="text-center" width="30"><a target="_blank" href="{{url('$data->link')}}">Cek</a></td>
                ...
                <td class="text-center">
                    @if($data->status=='P')
                        <button type="submit" name="status" value="terima" class="fa fa-check" style="color:green;"></button>
                        <button type="submit" name="status" value="tolak" class="fa fa-close" style="color:red;"></button>
                    @else
