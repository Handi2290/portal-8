          ...
          <div class="box-body">
            ...
            @else
              ...
              <div class="col-md-12">
                  ...
                  @else
                    <a href="{{ route('dosen.profil.foto.hapus') }}" onclick="return confirm('Anda Yakin Akan Menghapus Foto Profil ?')" class="btn btn-danger btn-sm col-md-offset-4" title="Hapus Foto"><i class="fa fa-trash-o"></i> Hapus Foto</a>
                  @endif
              </div>
            @endif
          </div>
        ...
        <div class="modal fade" id="ubah-foto">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              @else
              {!! Form::open(['method' => 'POST', 'route' => ['dosen.profil.foto'], 'files' => 'true']) !!}
              @endif
      ...
      <div class="col-md-8 col-xs-12">
        ...
        @else
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Data dosen <strong>{{ $profil->nama }}</strong></h3>
              <div class="box-tools pull-right">
                <a class="btn btn-primary btn-xs" title="Ubah Foto" data-toggle="modal" data-target="#ubah-foto"><i class="fa fa-edit"></i></a>
              </div>
            </div>
