          ...
          <div class="box-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                ...
                {!! Form::text('tmp_lahir', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
              ...
              <div class="col-md-6">
                ...
                {!! Form::text('tgl_lahir', null, ['class' => 'form-control date', 'autocomplete' => 'off', 'required']) !!}
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                ...
                {!! Form::select('agama', ['Islam' => 'Islam', 'Protestan' => 'Protestan', 'Katolik' => 'Katolik', 'Hindu' => 'Hindu', 'Buddha' => 'Buddha', 'Kong Hu Cu' => 'Kong Hu Cu'], null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                ...
                {!! Form::select('warga_negara', ['WNI' => 'WNI', 'WNA' => 'WNA'], null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
              ...
              <div class="col-md-6">
                ...
                {!! Form::select('status', ['Kawin' => 'Kawin', 'Belum Kawin' => 'Belum Kawin'], null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                ...
                {!! Form::select('id_prov', $provinsi, null, ['class' => 'form-control select-custom', 'autocomplete' => 'off', 'required']) !!}
              ...
              <div class="col-md-6">
                ...
                {!! Form::text('kota', null, ['class' => 'form-control', 'autocomplete' => 'off'], 'required') !!}
            ...
            <div class="form-group">
              ...
              {!! Form::textarea('alamat', null, ['class' => 'form-control', 'autocomplete' => 'off', 'rows' => '5', 'required']) !!}
            ...
            <div class="form-group">
              ...
              {!! Form::number('no_telp', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              {!! Form::text('nama_ibu', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
            ...
            <div class="form-group">
              ...
              {!! Form::text('nama_ayah', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
            ...
            <div class="form-group">
              ...
              {!! Form::textarea('alamat_ortu', null, ['class' => 'form-control', 'autocomplete' => 'off', 'rows' => '5', 'required']) !!}
            ...
            <div class="form-group">
              ...
              {!! Form::number('no_telp_ortu', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              {!! Form::text('asal_sekolah', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
            ...
            <div class="form-group">
              ...
              {!! Form::text('jurusan', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required']) !!}
            ...
            <div class="form-group">
              ...
              {!! Form::textarea('alamat_sekolah', null, ['class' => 'form-control', 'autocomplete' => 'off', 'required', 'rows' => '5']) !!}
