<header class="main-header">
  <!-- Logo -->
  <a href="../images/form/Form Dispensasi.jpeg" download class="logo">
  ...
  @if(Request::segment(1) == 'mahasiswa')
    <span class="logo-lg"><b>Form Dispensasi</b></span>
  @elseif(Request::segment(1) == 'dosen')
    ...
    <div class="navbar-custom-menu">
      {{-- menu notifikasi --}}
        <ul class="nav navbar-nav">
            <li class="pull-left">
                @if(Request::segment(1) == 'mahasiswa')
                  <a href="{{ route('mahasiswa.info') }}" title="Pengumuman"><i class="fa fa-bell"></i></a>
                @elseif(Request::segment(1) == 'dosen')
                  <a href="{{ route('dosen.info') }}" title="Pengumuman"><i class="fa fa-bell"></i></a>
                @elseif(Request::segment(1) == 'admin')
                  <a href="{{ route('admin.info') }}" title="Pengumuman"><i class="fa fa-bell"></i></a>
                @elseif(Request::segment(1) == 'admin_smk')
                  <a href="{{ route('admin_smk.info') }}" title="Pengumuman"><i class="fa fa-bell"></i></a>
                @elseif(Request::segment(1) == 'admin_smp')
                  <a href="{{ route('admin_smp.info') }}" title="Pengumuman"><i class="fa fa-bell"></i></a>
                @endif
              </li>
        ...
        <li class="pull-left">
          ...
          @if(Request::segment(1) == 'mahasiswa')
            <a href="#" title="Ubah Password"><i class="fa fa-lock"></i></a>
          @elseif(Request::segment(1) == 'dosen')
            <a href="#" title="Ubah Password"><i class="fa fa-lock"></i></a>
          @elseif(Request::segment(1) == 'admin')
            <a href="#" title="Ubah Password"><i class="fa fa-lock"></i></a>
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-left">
                @if(Request::segment(1) == 'mahasiswa')
                  <a href="#" class="btn btn-primary btn-flat" style="background-color:dodgerblue">Profile</a>
                @elseif(Request::segment(1) == 'dosen')
                  <a href="#" class="btn btn-primary btn-flat" style="background-color:dodgerblue">Profile</a>
                @elseif(Request::segment(1) == 'admin')
                  <a href="#" class="btn btn-primary btn-flat" style="background-color:dodgerblue">Profile</a>
