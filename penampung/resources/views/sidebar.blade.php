...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ route('mahasiswa.absen') }}"><i class="fa fa-check-square-o"></i> <span>Masuk Kelas</span></a></li>

        <li><a href="{{ route('mahasiswa.krs') }}"><i class="fa fa-id-card"></i> <span>Kartu Rencana Studi</span></a></li>

        <li><a href="{{ route('mahasiswa.jadwal') }}"><i class="fa fa-calendar"></i> <span>Jadwal Perkuliahan</span></a></li>

        <li class="treeview">

            <a href="#">

                <i class="fa fa-calendar"></i> <span>Jadwal & Kartu Ujian</span>
        ...
        <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        ...
                        <a href="images/form/bayar_mandiri.pdf" download>
            
                            <i class="fa fa-money"></i> Cara Bayar via Mandiri
        ...
        <li class="treeview">
            ...
            <a href="#">
                ...
                <i class="fa fa-calendar"></i> <span>Dokumen Akademik</span>
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="{{ route('mahasiswa.skpi') }}"><i class="fa fa-id-card"></i> <span>SKPI</span></a></li>

                <li><a href="{{ route('mahasiswa.pengajuan') }}"><i class="fa fa-book"></i> <span>Pengajuan Tugas Akhir</span></a></li>

            </ul>

        </li>

        <li><a href="https://perpustakaan.stieppi.ac.id/index.php?p=member" target="_blank"><i class="fa fa-book"></i> <span>Perpustakaan</span></a></li>

        <li class="treeview">
        <a href="#">

            <i class="fa fa-info"></i> <span>Informasi & Bantuan</span>
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="https://stieppi.ac.id/support" target="_blank"><i class="fa fa-desktop"></i> <span>Buat Tiket Bantuan</span></a></li>
        ...
        @elseif(Request::segment(1) == 'dosen')
            ...
            <li class="{{ (Request::segment(2) == 'absensi') ? 'active' : '' }}"><a href="{{ route('dosen.absensi') }}"><i class="fa fa-check-square-o"></i> <span>Masuk Kelas</span></a></li>
